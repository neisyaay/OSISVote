...
class Kandidat2View extends GetView<Kandidat2Controller> {
  const Kandidat2View({super.key});
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            'Menjadikan OSIS sebagai rumah bersama yang mewakili suara seluruh siswa dan mendorong terciptanya lingkungan sekolah yang harmonis.',
                            style: GoogleFonts.poppins(
                              fontSize: 14,
                              color: const Color(0xFF2C3E50),
                              height: 1.6,
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              _buildMissionItem(
                                number: '1',
                                text: 'Menyelenggarakan survey rutin untuk mengumpulkan aspirasi siswa dan menjadikannya dasar program kerja OSIS.',
                              ),
                              _buildMissionItem(
                                number: '2',
                                text: 'Meningkatkan peran OSIS sebagai penghubung antara siswa dan pihak sekolah.',
                              ),
                              _buildMissionItem(
                                number: '3',
                                text: 'Membentuk kelompok kerja yang melibatkan siswa lintas kelas dalam kegiatan OSIS.',
                              ),
                                _buildMissionItem(
                                number: '4',
                                text: 'Memastikan setiap program OSIS bermanfaat dan dapat dirasakan oleh seluruh siswa.',
                              ),
                              Container(
